            ...
            <div class="space-y-6 max-w-2xl mx-auto">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
                    ...
                    <div class="p-6 flex items-center">
                        <p class="text-gray-700">Просмотр и редактирование текущих оценок студентов.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
                    <div class="bg-red-600 text-white py-4 px-6">
                        <h2 class="text-2xl font-semibold">Отметки посещения</h2>
                    </div>
                    <div class="p-6 flex items-center">
                        <p class="text-gray-700">Учет посещаемости и просмотр статистики.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
                    <div class="bg-red-600 text-white py-4 px-6">
                        <h2 class="text-2xl font-semibold">Оценки за семестр</h2>
                    </div>
                    <div class="p-6 flex items-center">
