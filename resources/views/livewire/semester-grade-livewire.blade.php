...
<div class="container mx-auto px-4 py-8">
    <div class="flex flex-wrap items-center justify-between mb-8">
        <div class="flex items-center">
            <h1 class="text-3xl font-bold dark:text-gray-100 text-red-700 mr-4">Журнал оценок</h1>
        ...
        <div class="flex space-x-4">
            ...
            <select wire:model.lazy="selectedSemester" class="dark:bg-gray-800 dark:text-gray-200 bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
    ...
    <div class="overflow-x-auto">
        <table class="w-full dark:bg-gray-600 bg-white shadow-md rounded-lg">
            ...
            <tr class="dark:bg-gray-800 bg-red-600 text-white">
                ...
                <th class="py-3 px-6" colspan="3">Оценка</th>
            </tr>
            </thead>
            <tbody>
