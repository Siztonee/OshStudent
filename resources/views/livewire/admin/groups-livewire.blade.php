    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-stretch sm:items-center mb-6 space-y-4 sm:space-y-0 sm:space-x-4">
                <button class="w-full sm:w-auto bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg flex items-center justify-center">
            ...
            <div class="mb-6">
                <div class="relative">
                    <input type="text" placeholder="Поиск группы..." class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            @if (count($groups) === 0)
                <p class="text-center text-gray-500 mt-8">Группы не найдены</p>
            @endif
        </div>
    </div>
</div>
